...
export async function uploadToGemini(filePath: string): Promise<any> {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function waitForFileActive(file: any): Promise<any> {
  let current = file;
...
export function intensityToRange(intensity: number) {
